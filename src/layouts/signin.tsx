  ...
  return (
    <Fragment>
      <section className="">
        {width < 992 ? (
          <div
            className="flex bg-green-800 p-12 min-h-screen bg-no-repeat bg-cover justify-center"
            style={{
              backgroundImage:
                "url('/images/man-lady-farm.png'), url('/images/auth-vector-bg.png')",
          ...
          <div
            className="flex bg-green-800 p-12 min-h-screen"
            style={{
              backgroundImage:
                "url('/images/man-lady-farm.png'), url('/images/auth-vector-bg.png')",
