  ...
  return (
    <div className="flex gap-3 mt-8">
      <img
        ...
        src={imageUrl}
        alt={`${name} thumbnail`}
        className="object-contain rounded-xl aspect-[1.29] w-[135px]"
      />
  ...
  const vendors = [
    {
      ...
      description: "Ferterlizer Depot",
      imageUrl:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/1d5fce550305ddf7e2e68ea414b889885ca020b10df55e35bd846e250a464c42?placeholderIfAbsent=true&apiKey=e3159558e3c24b7bb6f2db02f0873db3",
    },
    {
      name: "Yohanna Enterprises",
      description: "Livestock feeds",
      imageUrl:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/65fc0ba1713f0925eb5cfc694e35ebfe73569066b68dad64676a4e9abddf2395?placeholderIfAbsent=true&apiKey=e3159558e3c24b7bb6f2db02f0873db3",
    },
    {
      name: "MaiAgro",
      description: "Enginnering Services",
      imageUrl:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/0f9d0d2204361e122c58dfe8261cf6da0d0cfe6534757c5847cd7bf6e223c5da?placeholderIfAbsent=true&apiKey=e3159558e3c24b7bb6f2db02f0873db3",
    },
    {
      name: "MaiAgro",
      description: "Enginnering Services",
