        ...
        <tbody>
          {farmerData.map((farmer) => (
            <tr key={farmer.id} className="border-b border-gray-200">
              ...
              <td className="py-4">
                <div
                  className={`px-2.5 py-1 rounded-[60px] w-fit border ${
                    farmer.fundingStatus === "Funded"
                      ? "text-teal-700 bg-green-50 border-teal-700"
                      : "bg-zinc-100"
                  }`}
                >
              ...
              <td className="py-4">
                <Link href="/admin/profile/farmers" className="text-teal-700">
                  View
                </Link>
              </td>
            </tr>
