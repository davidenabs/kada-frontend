...
const StatisticsCard: React.FC<StatisticsCardProps> = ({
  ...
  return (
    <a
      href={link}
      className={`flex overflow-hidden pr-1 pl-7 w-full text-3xl font-bold leading-tight ${backgroundColor} rounded max-md:pl-5 max-md:mt-5 hover:opacity-90 transition-opacity`}
    >
