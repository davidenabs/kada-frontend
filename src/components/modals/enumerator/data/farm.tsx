...
import { useGetFarmGalleryQuery, useVerifyFarmMutation } from "@/app/_api/farm";
    ...
    <div className="text-center max-h-[70vh] overflow-y-scroll p-4">
      <div className="bg-wh p-3">
        ...
        <div className=" mt-6">
          ...
          <p className="text-base font-thin pt-1">{farm?.landArea} HECTARES</p>
          <p className="text-sm font-thin pt-2">LGA: {farm?.lga}</p>
        </div>
