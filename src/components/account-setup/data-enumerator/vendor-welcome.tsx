...
const VendorWelcome: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      title:
        "Add products and services and make them visible to farmers and cooperatives",
      description:
        "Add products and services and make them visible to farmers and cooperatives",
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center rounded-none max-w-[882px] mx-auto">
      ...
      <Link href={"/account-setup/profile/vendor/welcome/certificate"}>
        <Button className="!px-10 !py-3 mt-10 text-sm font-bold !w-fit !rounded-full">
          Continue
        </Button>
      </Link>
    </div>
