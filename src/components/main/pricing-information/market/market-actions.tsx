...
const ActionButton: React.FC<ActionButtonProps> = ({ path, text }) => {
  return (
    <Link
      href={path}
      className="flex overflow-hidden flex-col justify-center self-stretch text-start px-2.5 py-7 my-auto leading-4 bg-white rounded-lg border border-solid border-slate-100 min-w-[240px] w-[251px]"
    >
