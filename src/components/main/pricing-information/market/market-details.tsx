            ...
            <div className="flex flex-col grow ">
                ...
                <div className="flex flex-col mt-3 max-w-full w-[313px]">
                    <div className="flex flex-col w-full text-xs whitespace-nowrap">
                        <div data-layername="day" className="font-semibold text-gray-400 tracking-[4.08px]">
                            DAY
                        </div>
                        <div className="flex gap-3 items-center self-start mt-5 font-medium text-center text-zinc-500">
                            {days.map((day, index) => (
                                <DayIndicator key={day} day={day} isActive={index < 3 || index > 4} />
                            ))}
                        </div>
                    </div>
                </div>
                <div className="flex flex-col mt-6 w-full font-semibold">
                    ...
                    <div className="mt-5 text-base text-zinc-700">
                        Large
                    </div>
                </div>
                <div className="flex flex-col mt-6 w-full font-semibold">
                    <div className="text-sm text-gray-400 tracking-[4.76px]">
                        TIMES
                    </div>
