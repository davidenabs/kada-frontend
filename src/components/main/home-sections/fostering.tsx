        ...
        <div className="flex flex-col md:w-[32%] w-full">
          <div className="flex relative flex-col   max-md:text-center items-center md:items-start my-auto md:w-full font-bold max-md:mt-10 mx-auto w-[345px]">
            ...
            <p className="mt-9 text-base leading-6 text-tertiary-700 font-thin">
              Development Agency paves the way for a sustainable future in
              Kaduna. Kaduna State Agricultural Development Agency paves the way
          ...
          <div className="relative grow max-md:mt-0 max-md:max-w-full">
            <div className="flex gap-5 ">
              <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <img
                  src="/images/fostering-g-1.png"
                  alt="Agricultural development visual"
                  className="object-contain grow w-full aspect-[0.7] max-md:mt-9 rounded-[32px]"
                />
              </div>
              <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                <img
                  src="/images/fostering-g-2.png"
                  alt="Sustainable farming practices"
                  className="object-contain grow w-full aspect-[0.7] rounded-[32px] max-md:mt-9"
                />
              </div>
            </div>
          </div>
