...
export const useGetMarkets = ({ enabled = true, params = {} }: IQueryParams) => {
...
export const useGetMarketProducts = ({ enabled = true, params = {} }: IQueryParams) => {
    return useQuery<IResponse<any>, Error>({
...
export const useGetMarketTemplate = ({ enabled = true, params = {} }: IQueryParams) => {
    return useQuery<IResponse<any>, Error>({
