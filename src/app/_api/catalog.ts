...
export const useGetProducts = ({ enabled = true, params = {} }: IQueryParams) => {
...
export const useGetCategories = ({ enabled = true, params = {} }: IQueryParams) => {
    return useQuery<IResponse<any>, Error>({
        queryKey: [API_ENDPOINTS.CATALOG_GET_PRODUCT_CATEGORIES],
