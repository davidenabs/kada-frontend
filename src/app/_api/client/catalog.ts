...
const catalogClient = {
  ...
  getProduct: (params: IParams, id: string): Promise<any> =>
    ApiClient.get(
      API_ENDPOINTS.CATALOG_GET_PRODUCT.replace(":productId", id),
      params
    ),
  ...
  deleteProduct: (id: string): Promise<any> =>
    ApiClient.delete(
      API_ENDPOINTS.CATALOG_DELETE_PRODUCT.replace(":productId", id)
    ),
  ...
  createCategory: (data: ICreateCategoryPayload): Promise<any> =>
    ApiClient.post(API_ENDPOINTS.CATALOG_CREATE_PRODUCT_CATEGORIES, data),
  updateCategory: (data: any, id: string): Promise<any> =>
    ApiClient.put(
      API_ENDPOINTS.CATALOG_UPDATE_PRODUCT_CATEGORIES.replace(
        ":categoryId",
        id
      ),
      data
  ...
  deleteCategory: (id: string): Promise<any> =>
    ApiClient.delete(
      API_ENDPOINTS.CATALOG_DELETE_PRODUCT_CATEGORIES.replace(":categoryId", id)
    ),
};
